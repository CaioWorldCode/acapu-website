        ...
        <React.Fragment>
            ...
            <div className="mt-10 mb-10">
                <div className="container mx-auto">
                    <div className="flex">
                        {/* CONSULTORIA DE TI */}
                        <div className="w-full relative m-3  p-3" data-aos="fade-up">
                            <div className="bg-white p-4 border border-default-100 rounded-md shadow-md">
                                <div className='flex justify-center items-center'>
                                    <GiBrain className='text-[75px] text-main-600 m-2'/>
                                </div>
                        ...
                        <div className="w-full relative m-3  p-3" data-aos="fade-up">
                            <div className="bg-white p-4 border border-default-100 rounded-md shadow-md">
                                <div className='flex justify-center items-center'>
                                    <RiTeamLine className='text-[75px] text-main-600 m-2'/>
                                </div>
                        ...
                        <div className="w-full relative m-3  p-3" data-aos="fade-up">
                            <div className="bg-white p-4 border border-default-100 rounded-md shadow-md">
                                <div className='flex justify-center items-center'>
                                    <IoIosApps className='text-[75px] text-main-600 m-2'/>
                                </div>
            ...
            {/* ACAPU */}
            <div className='bg-default-800  mt-10 mb-10'>
                ...
                <div className='container mx-auto'>
                    ...
                    <div className='flex'  data-aos="fade-right">
                        <div className='w-[10%] flex justify-center'>
                            <div className='border-[6px] border-main-500 rounded-full w-[80px] h-[80px] flex justify-center items-center text-3xl font-poppins font-extrabold shadow-lg'>
                                1
                            </div>
                        </div>
                        <div className='w-full'>
                            <p className='text-default-700  font-bold font-poppins text-xl'>Atende 100% da sua necessidade</p>
                            <p className='font-poppins text-default-700 mt-2'>Todas as funcionalidades são projetadas para atender às demandas específicas do seu negócio, sem funcionalidades desnecessárias ou ineficientes.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex mt-10'  data-aos="fade-right">
                        ...
                        <div className='w-full'>
                            <p className='text-default-700  font-bold font-poppins text-xl'>Sua empresa mais competitiva</p>
                            <p className='font-poppins text-default-700 mt-2'>Um sistema personalizado pode tornar a operação e gestão da sua empresa mais eficiente e eficaz, o que pode levar a uma vantagem competitiva no mercado.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex mt-10'  data-aos="fade-right">
                        ...
                        <div className='w-full'>
                            <p className='text-default-700  font-bold font-poppins text-xl'>Foco nos resultados</p>
                            <p className='font-poppins text-default-700 mt-2'>O projeto personalizado é desenvolvido com foco nos objetivos específicos do seu negócio, o que garante resultados mais rápidos e eficazes.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={`fixed bg-default-700 bottom-0 z-50 w-full h-[150px] ${cookies === 'consent' ? 'hidden' : 'block'}`}>
                <div className='container mx-auto h-full'>
                    <div className='flex h-full'>
                        <div className='w-[80%] flex gap-2 flex-col h-full justify-center items-center'>
                            <div className='text-white font-roboto font-extrabold text-[15px] w-full'>
                                Este site utiliza cookies!
                            </div>
                            <div className='text-white font-roboto font-normal'>
                        ...
                        <div className='w-[20%] flex justify-center items-center'>
                            <div onClick={() => hideCookies()} className='bg-main-500 p-5 w-[90%] font-poppins font-bold cursor-pointer hover:bg-main-700 flex justify-center items-center gap-4'>
                                <div>Ok entendi!</div>
