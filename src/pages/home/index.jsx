...
function Home() {
    ...
    const services = [
        {
            ...
            description:
                'Oferecemos soluções personalizadas para otimizar seus processos, garantindo um ambiente tecnológico seguro e alinhado às melhores práticas do setor.',
        ...
        },
        {
            name: 'Outsourcing',
            description:
                'Elevamos a produtividade e a flexibilidade do seu negócio por meio de serviços de outsourcing de TI',
        ...
        },
        {
            ...
            description:
                'Transforme suas ideias em realidade com nossos serviços especializados em desenvolvimento de aplicativos',
        ...
        },
        {
            ...
            description:
                'Potencialize a eficiência e a segurança da sua rede, enquanto impulsionamos o crescimento da sua empresa no mundo digital.',
            icon: (
                <BiSolidNetworkChart className="text-[75px] text-main-600 m-2" />
            ),
    ...
    return (
        <React.Fragment>
                ...
                <div className="container mx-auto">
                    <div className="flex max-lg:hidden">
                        {services.map((row, index) => {
                            return (
                                <div
                                    className="w-full relative m-3  p-3"
                                    data-aos="fade-up"
                                    key={index}
                                >
                                    <div className="bg-white p-4 border border-default-100 rounded-md shadow-md">
                                        ...
                                        <div className="flex justify-center items-center">
                                            <div
                                                className="font-poppins font-bold  text-lg uppercase text-default-700 bg-main-600 pr-5 pl-5 m-2 "
                                                style={{
                                                    clipPath:
                                                        'polygon(8% 0%, 100% 0%, 92% 100%, 0% 100%)',
                                                }}
                                    ...
                                    <SwiperSlide key={index}>
                                        <div className="border  rounded-lg border-default-100 m-5 flex">
                                            <div className="w-[100%]">
                                                ...
                                                <div
                                                    className="font-poppins font-bold  text-lg uppercase text-default-700 bg-main-600 ml-[20px] mr-[20px] m-2 text-center"
                                                    style={{
                                                        clipPath:
                                                            'polygon(8% 0%, 100% 0%, 92% 100%, 0% 100%)',
                                                    }}
                ...
                <div className="container mx-auto h-full pt-5 pb-5">
                    <div className="flex h-full">
                        ...
                        <div className="w-[50%] max-lg:w-[100%] h-full">
                            <div className="p-5">
                                <div className="text-white font-bold font-poppins text-3xl">
                                    ACAPU
                                </div>
                                <p className="text-white font-poppins mt-3">
                                    Há mais de 20 anos, a Acapu Tecnologia vem
                                    crescendo no mercado, sempre focada na
                                    entrega de soluções de alta qualidade para
                                    nossos clientes.{' '}
                                </p>
                                <p className="text-white font-poppins mt-6">
                                    Estamos sempre antenados nas novas
                                    tecnologias e ferramentas disponíveis no
                                    mercado para que possamos utilizá-las da
                                    melhor maneira em nossa empresa para
                                ...
                                <p className="text-white font-poppins mt-6">
                                    ...
                                    é uma empresa exclusivamente nacional e foi
                                    criada com o objetivo de oferecer soluções
                                    integradas de infraestrutura nas áreas de
                                    engenharia elétrica e telecomunicações,
                                    sempre acompanhando às necessidades do
                                    mercado e desenvolvimento soluções de
                                    infraestrutura elétrica, lógica e
                ...
                <div className="container mx-auto">
                    ...
                    <div className="flex" data-aos="fade-right">
                        ...
                        <div className="w-full max-lg:w-[80%]">
                            <p className="text-default-700  font-bold font-poppins text-xl max-lg:text-[11pt] max-lg:ml-2 max-lg:mr-2">
                                Atende 100% da sua necessidade
                            </p>
                            <p className="font-poppins text-default-700 mt-2 max-lg:mr-4 max-lg:ml-2 max-lg:text-sm">
                                Todas as funcionalidades são projetadas para
                                atender às demandas específicas do seu negócio,
                                sem funcionalidades desnecessárias ou
                                ineficientes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex mt-10" data-aos="fade-right">
                        ...
                        <div className="w-full max-lg:w-[80%]">
                            ...
                            <p className="font-poppins text-default-700 mt-2 max-lg:mr-4 max-lg:ml-2 max-lg:text-sm">
                                Um sistema personalizado pode tornar a operação
                                e gestão da sua empresa mais eficiente e eficaz,
                                o que pode levar a uma vantagem competitiva no
                                mercado.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex mt-10" data-aos="fade-right">
                        ...
                        <div className="w-full max-lg:w-[80%]">
                            ...
                            <p className="font-poppins text-default-700 mt-2 max-lg:mr-4 max-lg:ml-2 max-lg:text-sm">
                                O projeto personalizado é desenvolvido com foco
                                nos objetivos específicos do seu negócio, o que
                                garante resultados mais rápidos e eficazes.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* COOKIES */}
            <div
                className={`fixed bg-default-700 bottom-0 z-50 w-full h-[150px] max-lg:h-[200px] ${
                    cookies === 'consent' ? 'hidden' : 'block'
                }`}
            >
                    ...
                    <div className="flex h-full max-lg:flex-col max-lg:gap-2">
                        <div className="w-[80%] max-lg:w-[100%] flex gap-2 flex-col h-full justify-center items-center">
                            ...
                            <div className="text-white font-roboto font-normal max-lg:text-[12px]">
                                Utilizamos cookies para personalizar conteúdo e
                                anúncios, fornecer funcionalidades de redes
                                sociais e analisar o nosso tráfego. Também
                                partilhamos informações acerca da sua utilização
                                do site com os nossos parceiros de redes
                                sociais, de publicidade e de análise, que as
                                podem combinar com outras informações que lhes
                                forneceu ou recolhidas por estes a partir da sua
                                utilização dos respetivos serviços.
                            </div>
                        </div>
                        ...
                        <div className="w-[20%] max-lg:w-[100%] flex justify-center items-center">
                            <div
                                onClick={() => hideCookies()}
                                className="bg-main-500 p-5 max-lg:p-2 w-[90%] max-lg:w-[80%] font-poppins font-bold cursor-pointer hover:bg-main-700 flex justify-center items-center gap-4"
                            >
                                <div>Ok entendi!</div>
